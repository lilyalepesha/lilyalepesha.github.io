...
/* harmony import */ var _app_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app/swiper */ "./resources/js/app/swiper.js");
/* harmony import */ var _app_swiper__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_app_swiper__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _app_accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app/accordion */ "./resources/js/app/accordion.js");
/* harmony import */ var _app_accordion__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_app_accordion__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _app_burgerMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/burgerMenu */ "./resources/js/app/burgerMenu.js");
/* harmony import */ var _app_preloader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app/preloader */ "./resources/js/app/preloader.js");
/* harmony import */ var _app_preloader__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_app_preloader__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _app_buttonToTop__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app/buttonToTop */ "./resources/js/app/buttonToTop.js");
/* harmony import */ var _app_buttonToTop__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_app_buttonToTop__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _app_buttons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app/buttons */ "./resources/js/app/buttons.js");
/* harmony import */ var _app_buttons__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_app_buttons__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _app_validation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./app/validation */ "./resources/js/app/validation.js");
/* harmony import */ var _app_validation__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_app_validation__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _app_popup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app/popup */ "./resources/js/app/popup.js");
/* harmony import */ var _app_tabs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app/tabs */ "./resources/js/app/tabs.js");
/* harmony import */ var _app_tabs__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_app_tabs__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _app_beforeAfter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./app/beforeAfter */ "./resources/js/app/beforeAfter.js");
/* harmony import */ var _app_beforeAfter__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_app_beforeAfter__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _app_maskPhone__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./app/maskPhone */ "./resources/js/app/maskPhone.js");
...
function accordion(wrapperClass, triggerClass, accordionClass, activeClass) {
  ...
  wrapper.each(function () {
    ...
    var accordion = $(this).find('.' + accordionClass);
...
/***/ "./resources/js/app/beforeAfter.js":
/*!*****************************************!*\
  !*** ./resources/js/app/beforeAfter.js ***!
  \*****************************************/
/***/ (() => {
...
function beforeAfterSlider(slider) {
  var resize = slider.find('.complexity-slide__img-before');
  var button = slider.find('.complexity-slide__img-button');
...
$(window).on('DOMContentLoaded', function () {
  var sliders = $('.complexity-slide__img');
...
/***/ "./resources/js/app/burgerMenu.js":
/*!****************************************!*\
  !*** ./resources/js/app/burgerMenu.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scroll */ "./resources/js/app/scroll.js");

function burgerMenu(burgerButtonClass, menuClass, activeClass) {
  var burgerButton = document.querySelector('.' + burgerButtonClass);
  var header = document.querySelector('.' + menuClass);
  burgerButton.addEventListener('click', function (e) {
    ...
    if (header.classList.contains(activeClass)) {
      _scroll__WEBPACK_IMPORTED_MODULE_0__["default"].disableScroll(header);
    } else {
      _scroll__WEBPACK_IMPORTED_MODULE_0__["default"].enableScroll(header);
    }
  });
}
...
/***/ "./resources/js/app/buttonToTop.js":
/*!*****************************************!*\
  !*** ./resources/js/app/buttonToTop.js ***!
  \*****************************************/
/***/ (() => {
...
function setMaskPhone() {
  ...
  phoneInputs.forEach(function (phone) {
    var phoneMask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](phone, {
...
function popupScroll(formOverlay, closeButtonClass, formClass, buttonClass) {
  var popup = document.querySelector('.' + formOverlay);
  var closeButton = popup.querySelector('.' + closeButtonClass);
  var button = popup.querySelector('.' + buttonClass);
  var isOpened = false;
  window.addEventListener('scroll', function () {
    if (window.scrollY >= 1000 && !isOpened) {
      _scroll__WEBPACK_IMPORTED_MODULE_0__["default"].disableScroll(popup);
  ...
  closeButton.addEventListener('click', function () {
    ...
    _scroll__WEBPACK_IMPORTED_MODULE_0__["default"].enableScroll(popup);
  });
...
var Scroll = /*#__PURE__*/function () {
  ...
  _createClass(Scroll, null, [{
    ...
    key: "disableScroll",
    value: function disableScroll(block) {
    ...
    key: "enableScroll",
    value: function enableScroll(block) {
...
function slider(slider, buttonNext, buttonPrev) {
  var pagination = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var sliderPerView = arguments.length > 4 ? arguments[4] : undefined;
...
window.addEventListener('DOMContentLoaded', function () {
  slider('complexity__slider', 'complexity__slider-button--next', 'complexity__slider-button--prev', 'swiper-pagination', 1);
  slider('certificates__slider', 'certificates__slider-button--next', 'certificates__slider-button--prev', null, 3);
});
...
function tabs(tabsButtonClass, tabsContentClass, tabsButtonClassActive, tabsContentClassActive) {
  var tabsButton = document.querySelectorAll('.' + tabsButtonClass);
  var tabsContent = document.querySelectorAll('.' + tabsContentClass);
...
window.addEventListener('DOMContentLoaded', function () {
  tabs('cleaning__list-item', 'cleaning__tab', 'cleaning__list-item--active', 'active');
});
...
function phoneNumberPattern(phoneNumber) {
  var pattern = /^\+375\(\d{2}\)\d{2}-\d{2}-\d{3}$/;
  return pattern.test(phoneNumber);
}
function validateInputPhone(formClass, buttonClass, errorClass) {
  var form = document.querySelector('.' + formClass);
  var inputPhone = form.querySelector('input');
  var button = document.querySelector('.' + buttonClass);
  var error = form.querySelector('.' + errorClass);
...
function addPhoneMask(phoneNumberInputClass) {
  var phoneNumberInput = document.querySelector('.' + phoneNumberInputClass);
